...
public class PddActivity extends AbstractJni implements IOResolver<AndroidFileIO> {
...
//                .build();
        ...
        vm = emulator.createDalvikVM(new File("unidbg-android/src/test/java/com/phil/pdd/拼多多官方.apk"));
        ...
        DalvikModule dm_libUserEnv = vm.loadLibrary(new File("unidbg-android/src/test/java/com/phil/pdd/libUserEnv.so"), true);
        dm_libUserEnv.callJNI_OnLoad(emulator);
        DalvikModule dm = vm.loadLibrary(new File("unidbg-android/src/test/java/com/phil/pdd/libpdd_secure.so"), true);
        module = dm.getModule();
    ...
    public static void main(String[] args) {
        ...
        PddActivity pddActivity = new PddActivity();
        System.out.println("load offset=" + (System.currentTimeMillis() - start) + "ms");
        pddActivity.nativeGenerate2();
    }
    ...
    private void nativeGenerate2() {
        ...
        list.add(vm.addLocalObject(new StringObject(vm, "ChUTbmEXjiUpjF5Q8W40Ag==")));
        list.add(vm.addLocalObject(new StringObject(vm, "Iqy8ijyU")));
        list.add(vm.addLocalObject(new StringObject(vm, "/storage/emulated/0")));
...
//                return vm.resolveClass("android/telephony/TelephonyManager").newObject(signature);
    ...
    public DvmObject<?> callObjectMethodV(BaseVM vm, DvmObject<?> dvmObject, String signature, VaList vaList) {
        switch (signature) {
            ...
            case "java/lang/String->toUpperCase()Ljava/lang/String;":
                return new StringObject(vm, dvmObject.getValue().toString().toUpperCase());
            case "android/telephony/TelephonyManager->getDeviceId()Ljava/lang/String;":
            ...
            case "java/lang/Object->getClass()Ljava/lang/Class;": {
                if ("com/android/internal/telephony/ITelephony$Stub->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/ITelephony;".equals(dvmObject.getValue().toString())) {
    ...
    public FileResult<AndroidFileIO> resolve(Emulator<AndroidFileIO> emulator, String pathname, int oflags) {
        ...
        if (pathname.equals("/proc/cpuinfo")) {
            return FileResult.success(new SimpleFileIO(oflags, new File("unidbg-android/src/test/java/com/phil/pdd/cpuinfo"), pathname));
        }
        return null;
    }
}
