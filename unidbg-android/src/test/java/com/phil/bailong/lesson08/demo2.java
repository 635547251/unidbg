package com.phil.bailong.lesson08;
...
public class demo2 extends AbstractJni {
    ...
    demo2(){
        ...
        vm = emulator.createDalvikVM(new File("unidbg-android/src/test/java/com/phil/bailong/lesson08/demo2.apk"));

        // 注册libandroid.so虚拟模块
        new AndroidModule(emulator, vm).register(memory);

        DalvikModule dm = vm.loadLibrary(new File("unidbg-android/src/test/java/com/phil/bailong/lesson08/readassets.so"), true);
        module = dm.getModule();
